...
sudo sed -i 's/collections.MutableMapping/collections.abc.MutableMapping/g' /usr/local/lib/python3.12/site-packages/shadowsocks-3.0.0-py3.12.egg/shadowsocks/lru_cache.py
